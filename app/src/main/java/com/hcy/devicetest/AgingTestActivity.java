...
import com.hcy.devicetest.aging.AgingCallback;
import com.hcy.devicetest.aging.AgingConfig;
import com.hcy.devicetest.aging.AgingDelegate;
import com.hcy.devicetest.aging.CpuTest;
import com.hcy.devicetest.aging.GpuTest;
import com.hcy.devicetest.aging.MemoryTest;
import com.hcy.devicetest.aging.VpuTest;
import com.hcy.devicetest.constants.ResourceConstants;
import com.hcy.devicetest.enumerate.AgingType;
import com.hcy.devicetest.service.TestService;
import com.hcy.devicetest.service.WatchdogService;
import com.hcy.devicetest.utils.IniEditor;
import com.hcy.devicetest.utils.LogUtil;
import com.hcy.devicetest.utils.SystemInfoUtils;
import com.hcy.devicetest.utils.TestConfigReader;
...
public class AgingTestActivity extends BaseActivity implements AgingCallback {
    ...
    public static final String AGINGTEST_FOREGROUND_ACTION = "com.hcy.devicetest.state.foreground";
    public static final String AGINGTEST_BACKGROUND_ACTION = "com.hcy.devicetest.state.background";
	...
	//	sendBroadcast(keyIntent);
		...
		agingIntent.setAction("com.hcy.devicetest.action.WATCH_DOG");
